          ...
          <div class="nutrition-facts">
            ...
            <div class="top">
              <span id="serv-size-row">
                <h3>Serving Size</h3><h3 id="servAmnt"></h3>
                <h3 id="servMeas"></h3>
              </span>
              <span id="serv-cont-row">
                <h3>Servings Per Container</h3><h3 id="servCont"></h3>
              </span>
            </div>
            {/* <!-- TOP SUB HEADING --> */}
            <div>
              ...
              <div class="calories-line">
                <h3>Calories</h3>
                <h3 id="calories">{vals.nf_calories}</h3>
              ...
              <div class="sub-heading">
                <div id="tot-fat-inner-row">
                  <h4>Total Fat</h4><h4 id="totalFat">{vals.nf_total_fat}</h4>
                </div>
                <div>
                  <h3>%</h3>
                </div>
              ...
              <div class="fat-sub-heading">
                <div class="sat-fat">
                  <span>
                    <h3>Saturated Fat{vals.nf_saturated_fat}</h3>
                  </span>
                  <h3>%</h3>
                </div>
                <h3>Trans Fat</h3>
            ...
            <div class="chol">
              <h4>Cholesterol{vals.nf_cholesterol}</h4>
              <h3>%</h3>
            </div>
            <div class="sodium">
              <h4>Sodium{vals.nf_sodium}</h4>
              <h3>%</h3>
            </div>
            <div class="total-carb">
              <div id="tot-carb-inner-row">
                <h4>Total Carbohydrate{vals.nf_total_carbohydrate}</h4><h4 id="totalCarb"></h4>
              </div>
              <div>
                <h3>%</h3>
              </div>
            ...
            <div class="carb-sub-heading">
              <div class="diet-fiber">
                <h3>Dietary Fiber{vals.nf_dietary_fiber}</h3>
                <h3>%</h3>
              </div>
              <h3>Sugars{vals.nf_sugars}</h3>
            </div>
            <div class="protein">
              <h4>Protein</h4><h4 id="protein">{vals.nf_protein}</h4>
            </div>
            {/* <!-- BOTTOM SECTION --> */}
            <div class="vitA">
              <h3>Vitamin A</h3>
